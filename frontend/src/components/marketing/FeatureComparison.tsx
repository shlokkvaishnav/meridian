        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-foreground/[0.06]">
              <th className="text-left py-3 px-4 text-sm font-semibold text-foreground/80">Feature</th>
              <th className="text-center py-3 px-4 text-sm font-semibold text-foreground/80">Hobby</th>
              <th className="text-center py-3 px-4 text-sm font-semibold text-primary">Pro</th>
              <th className="text-center py-3 px-4 text-sm font-semibold text-foreground/80">Team</th>
            </tr>
          </thead>
          <tbody>
            {features.map((feature, idx) => (
              <tr
                key={feature.name}
                className={`border-b border-foreground/[0.03] ${idx % 2 === 0 ? 'bg-foreground/[0.01]' : ''}`}
              >
